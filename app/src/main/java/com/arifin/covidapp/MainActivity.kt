...
import com.arifin.covidapp.adapter.CountryAdapter
import com.arifin.covidapp.model.AllNegara
import com.arifin.covidapp.model.Negara
import com.arifin.covidapp.network.ApiService
import com.arifin.covidapp.network.RetrofitBuilder.retrofit
...
//
//
////    untuk mengukurtkan list negara sesuai huruf dan bisa di ubah urutannya
    private var asceding = true
//
//
    companion object{
...
//
    private fun intializeView() {
        sequnce.setOnClickListener{
            sequenceWithoutInternet(asceding)
            asceding = !asceding
        }
    }
//
